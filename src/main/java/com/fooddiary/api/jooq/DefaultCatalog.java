...
public class DefaultCatalog extends CatalogImpl {
    ...
    /**
     * The schema <code>my_food_diarybook</code>.
     */
    public final MyFoodDiarybook MY_FOOD_DIARYBOOK = MyFoodDiarybook.MY_FOOD_DIARYBOOK;
    ...
    public final List<Schema> getSchemas() {
        return Arrays.asList(
            MyFoodDiarybook.MY_FOOD_DIARYBOOK
        );
    }
