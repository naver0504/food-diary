...
public class Tag extends TableImpl<TagRecord> {
    ...
    /**
     * The reference instance of <code>my_food_diarybook.tag</code>
     */
    ...
    /**
     * The column <code>my_food_diarybook.tag.diarybook_id</code>.
     */
    public final TableField<TagRecord, Long> DIARYBOOK_ID = createField(DSL.name("diarybook_id"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>my_food_diarybook.tag.name</code>.
     */
    public final TableField<TagRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(200), this, "");

    /**
     * The column <code>my_food_diarybook.tag.create_at</code>.
     */
    public final TableField<TagRecord, LocalDateTime> CREATE_AT = createField(DSL.name("create_at"), SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");
    ...
    /**
     * Create an aliased <code>my_food_diarybook.tag</code> table reference
     */
    ...
    /**
     * Create a <code>my_food_diarybook.tag</code> table reference
     */
    public Tag() {
