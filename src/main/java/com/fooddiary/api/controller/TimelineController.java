...
public class TimelineController {
    ...
    public ResponseEntity<List<TimelineDiaryDTO>> showMoreDiary(final @RequestParam LocalDate date, final @RequestParam int offset, final @AuthenticationPrincipal User user) {
        return ResponseEntity.ok(timelineService.getMoreDiary(date, offset, user));
    }
